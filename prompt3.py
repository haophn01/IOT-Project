...
try:
    ...
    print(f"Average antmeter for fridge 1: {fridge1_average:.10f}")
    print(f"Average antmeter for fridge 2: {fridge2_average:.10f}")
    print(f"Average antmeter for fridge 3: {dishwasher_average:.10f}")
    print(f"Overall average anmeter: {overall_average:.10f}")
